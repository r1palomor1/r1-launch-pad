...
const AUDIO_ICON_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M7 17.013V6.987c0-1.02.7-1.75 1.615-1.22l8.333 5.013c.875.526.875 1.914 0 2.44l-8.333 5.013C7.7 18.762 7 18.032 7 17.013z"></path></svg>`;
// --- ⬇️ ADDED FOR VOLUME ⬇️ ---
