...
/* 🧠 R1 Compact Detection — Best Practice Placement
   Activates the R1 compact UI mode early in the render process.
   Keeps desktop layout unaffected. Runs once at startup.
*/
if (window.rabbit || window.creationStorage) {
    document.body.classList.add("r1-compact");
}
